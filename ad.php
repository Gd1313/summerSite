...
<div id="main">
    <div id="news">
      <h2 class="heading">Summer jokes</h2>
      <div style="clear:both"><br></div>
      <div class="block">

          <ul>
            <li>Лупа и Пупа устроились на работу. Проработали целый месяц, трудились не покладая рук и не жалея живота своего. В конце месяца Лупа и Пупа пошли получать зарплату. В бухгалтерии все как обычно перепутали. И, в итоге, Лупа получил за Пупу, а Пупа за ЛУПУ!</li>
            <li>Сенсация: китайская молния на турецких джинсах спасла женщину от изнасилования!</li>
          </ul>
